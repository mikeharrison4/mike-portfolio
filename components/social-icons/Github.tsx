...
function Github() {
  return (
    <>
      <g className="social-svg-icon" style={{ transition: 'fill 170ms ease-in-out 0s', fill: 'transparent' }}>
        <path
      ...
      <g className="social-svg-mask" style={{ transition: 'fill 170ms ease-in-out 0s', fill: 'white' }}>
        <path
